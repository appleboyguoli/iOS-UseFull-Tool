...
{
    self.textField.text = [FBEncryptorAES encryptBase64String:@"10001sograndwap" keyString:@"1234567890123456" separateLines:YES];
    self.encodeStr = self.textField.text;
    
}

- (void)unencode:(id)sender
{
    self.textField.text = [FBEncryptorAES decryptBase64String:self.encodeStr keyString:@"1234567890123456"];
